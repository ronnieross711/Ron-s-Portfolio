...
function About(props) {
    return (
        <div className='about'>
            ...
            <p className='second'>     
                I have a an old hard working mindset and I don't want things in life given to me. I enjoy the pain and 
                frustration of working hard to succeed. There's nothing like that feeling of success after hours or even
                days of trial and error. I learned how to take apart and engine from my father and I chose to 
